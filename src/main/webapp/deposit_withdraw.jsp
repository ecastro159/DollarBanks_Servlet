			...
			<div class="row justify-content-center">
				...
				<div class="col align-self-center">
					<div class="container">
						...
						<div class="card">
							<div class="card-header display-5 text-center fw-bolde">Deposit or Withdraw</div>
							<div class="card-body">
								<form class="row g-3 needs-validation" action="deposit_withdraw"
									method="post">

									<div class="col-md-4">
										<label for="validationCustom01" class="form-label">Transaction
											Type</label> <select class="form-select" id="validationCustom04"
											required name="transaction">
